...
public class PVPChestModule
{
    ...
    public void UpdateView()
    {
        ...
        if (_parentManager.sys._pvpbattle._pvpplayer.playerToPlayer.ContainsKey(PlayerUID))
        {
            int RoomID = _parentManager.sys._pvpbattle._pvpplayer.playerToPlayer[PlayerUID].RoomID;
